  ...
  const reload = useCallback(async () => {
    ...
    try {
      ...
      docs.forEach(bourse => {
        ...
        if (!uniqueMap.has(key)) uniqueMap.set(key, bourse);
      });
...
const S = {
  ...
  h2: { fontSize: '1.8rem', fontWeight: 800, color: '#0f172a', marginBottom: 8 },
  sub: { color: '#475569', fontSize: 14 },
  loadingBox: { display: 'flex', alignItems: 'center', gap: 12, padding: '24px', color: '#475569' },
  emptyBox: { display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '48px 24px', borderRadius: 16, background: '#ffffff', border: '1px dashed rgba(15,23,42,.04)' },
  ...
  btnRefresh: { padding: '8px 16px', borderRadius: 8, background: 'transparent', border: '1px solid rgba(15,23,42,.06)', color: '#475569', fontSize: 12, cursor: 'pointer', alignSelf: 'flex-start' },
  timelineCard: { borderRadius: 16, background: '#ffffff', border: '1px solid rgba(15,23,42,.06)', overflow: 'hidden', boxShadow: '0 6px 18px rgba(12,18,40,0.04)' },
  bourseHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 22px', cursor: 'pointer' },
  bourseInfo: { flex: 1 },
  bourseName: { fontSize: 16, fontWeight: 700, color: '#0f172a', marginBottom: 4 },
  bourseMeta: { display: 'flex', gap: 14, fontSize: 12, color: '#64748b', flexWrap: 'wrap' },
  bourseUrl: { display: 'inline-block', marginTop: 6, fontSize: 12, color: '#6366f1', textDecoration: 'none' },
  statutBadge: { fontSize: 11, padding: '2px 8px', borderRadius: 8, fontWeight: 600 },
  pctBadge: { padding: '4px 12px', borderRadius: 99, background: 'rgba(99,102,241,.06)', border: '1px solid rgba(15,23,42,.04)', color: '#4f46e5', fontSize: 12, fontWeight: 700 },
  chevron: { fontSize: 22, color: '#334155', transition: 'transform .2s' },
  timelineBody: { padding: '0 22px 22px', borderTop: '1px solid rgba(15,23,42,.04)' },
  conseilGlobal: { margin: '16px 0 20px', padding: '12px 16px', borderRadius: 10, background: '#f8fafc', border: '1px solid rgba(15,23,42,.04)', color: '#334155', fontSize: 13, lineHeight: 1.6 },
  genLoading: { display: 'flex', alignItems: 'center', gap: 12, padding: '24px', color: '#475569', fontSize: 13 },
  ...
  stepTitle: { fontSize: 15, fontWeight: 700, marginBottom: 2, color: '#0f172a' },
  deadline: { fontSize: 11, color: '#b45309', fontWeight: 600 },
  dureeBadge: { padding: '2px 8px', borderRadius: 99, background: 'rgba(139,92,246,.06)', border: '1px solid rgba(139,92,246,.08)', color: '#7c3aed', fontSize: 11 },
  stepNum: { fontSize: 11 },
  stepDesc: { fontSize: 13, lineHeight: 1.55, marginBottom: 10, color: '#334155' },
  docsBox: { marginBottom: 10, padding: '10px 14px', borderRadius: 10, background: '#ffffff', border: '1px solid rgba(15,23,42,.04)' },
  docsTitle: { fontSize: 11, color: '#334155', fontWeight: 700, letterSpacing: 1, marginBottom: 8, textTransform: 'uppercase' },
  ...
  stepLink: { display: 'inline-block', marginBottom: 10, fontSize: 12, color: '#6366f1', textDecoration: 'none' },
  ...
  btnAI: { padding: '8px 14px', borderRadius: 8, background: '#f8fafc', border: '1px solid rgba(15,23,42,.04)', color: '#334155', fontSize: 12, cursor: 'pointer' },
  btnDone: { padding: '8px 14px', borderRadius: 8, background: '#ffffff', border: '1px solid rgba(15,23,42,.04)', color: '#475569', fontSize: 12, cursor: 'pointer' },
  ...
  progressBox: { marginTop: 20, padding: '16px 18px', borderRadius: 12, background: '#ffffff', border: '1px solid rgba(15,23,42,.04)' },
  ...
  chatPanel: { width: 340, flexShrink: 0, background: '#ffffff', border: '1px solid rgba(15,23,42,.04)', borderRadius: 16, overflow: 'hidden', position: 'sticky', top: 80, display: 'flex', flexDirection: 'column', maxHeight: 'calc(100vh - 100px)' },
  chatHead: { display: 'flex', gap: 10, alignItems: 'center', padding: '14px 16px', borderBottom: '1px solid rgba(15,23,42,.04)' },
  chatMessages: { flex: 1, overflowY: 'auto', padding: 12, minHeight: 300 },
  suggestBtn: { display: 'block', width: '100%', textAlign: 'left', padding: '8px 12px', borderRadius: 8, background: '#f8fafc', border: '1px solid rgba(15,23,42,.04)', color: '#475569', fontSize: 12, cursor: 'pointer', marginBottom: 6, lineHeight: 1.4 },
  msg: { display: 'flex', gap: 8, marginBottom: 12, maxWidth: '92%' },
  msgUser: { marginLeft: 'auto', flexDirection: 'row-reverse' },
  avatar: { width: 28, height: 28, borderRadius: '50%', background: '#eef2ff', border: '1px solid rgba(15,23,42,.04)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, flexShrink: 0 },
  avatarUser: { background: '#f3e8ff', borderColor: 'rgba(124,58,237,.15)' },
  bubble: { padding: '10px 14px', borderRadius: 14, fontSize: 13, lineHeight: 1.5, wordBreak: 'break-word' },
  bubbleAI: { background: '#f8fafc', border: '1px solid rgba(15,23,42,.04)', color: '#0f172a', borderTopLeftRadius: 4 },
  ...
  // Nouveau style pour le bouton poubelle
  ...
  // Amélioration du bouton corbeille (plus visible et mieux placé)
  deleteBtn: {
